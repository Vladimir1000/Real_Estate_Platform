...
const PropertyDetails = () => {
  ...
  useEffect(() => {
    console.log("Property ID:", id);  // Debugging
    if (id !== 'new') {
...
// const USERS_PATH = "http://127.0.0.1:8000/users/";
...
//   //     try {
//   //       const response = await axios.get(`${USERS_PATH}${loggedInUser}`);
...
//   //   try {
//   //     await axios.post(`${USERS_PATH}${loggedInUser}/add_property/`, { property_id: propertyId });
...
//   //   try {
//   //     await axios.post(`${USERS_PATH}${loggedInUser}/remove_property/`, { property_id: propertyId });
...
//           <label>
//             User ID:
//             <input type="text" name="user_id" value={property.user_id} onChange={handleChange} required />
//           </label>
//           {/* <label>
//             Latitude:
//             <input type="number" name="latitude" value={property.latitude} onChange={handleChange} required />
//           </label>
//           <label>
//             Longitude:
//             <input type="number" name="longitude" value={property.longitude} onChange={handleChange} required />
//           </label> */}
//           <button type="submit">{id ? 'Update' : 'Create'} Property</button>
//         </form>
//       ) : (
//         <>
//           {/* {loggedInUser && (
